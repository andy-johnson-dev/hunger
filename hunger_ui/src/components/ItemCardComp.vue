<template>
  <v-card class="ma-2" max-width="275px">
    ...
    <v-card-title style="font: 1em sans-serif">
      Kroger® 2% Reduced Fat Milk
    </v-card-title>

    <v-card-subtitle style="font: 0.7em sans-serif"> 1 gal </v-card-subtitle>
    ...
    <v-card-actions>
      ...
      <v-btn
        :icon="saved ? 'mdi-cart-remove' : 'mdi-cart-plus'"
        @click="saved = !saved"
      ></v-btn> -->
      <v-btn rounded="lg" color="secondary" variant="flat" block
        >Add To Cart</v-btn
      >
    </v-card-actions>
          ...
          <table width="242" cellspacing="0" cellpadding="0">
            <tbody>
              ...
              <tr>
                <td>
                  <div class="serving">
                    Per <span class="highlighted">180.0g</span> Serving Size
                  </div>
                </td>
              </tr>
              <tr style="height: 7px">
              ...
              <tr>
                <td>
                  <div class="line">
                    ...
                    <div
                      style="padding-top: 1px; float: right"
                      class="labellight"
                    >
                      Calories from Fat
                    ...
                    <div class="labellight">
                      * Based on a regular <a href="#">2000 calorie diet</a>
                      <br /><br /><i
                        ...
                        used as a guide for approximation.</i
                      >
                    </div>
                  </div>
                </td>
